...
@Route("/mapsa")
public class MapsUI extends VerticalLayout {
public MapsUI(){

    add(new Text("Welcome to mapsa view"))  ;
    ...
    HorizontalLayout layout = new HorizontalLayout(normalButton,smallButton,createButton);
