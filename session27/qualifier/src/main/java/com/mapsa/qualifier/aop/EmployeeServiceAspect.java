...
public class EmployeeServiceAspect
{
    ...
    @Before(value = "execution(* com.mapsa.qualifier.aop.EmployeeService.*(..)) and args(empId, fname, sname)")
    ...
    @After(value = "execution(* com.mapsa.qualifier.aop.EmployeeService.*(..)) and args(empId, fname, sname)")
