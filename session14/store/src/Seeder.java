...
public class Seeder {
 ...
 private List<Basket>   basketList;
    ...
    public void seed(){
        ...
        ////////////////////
        Product p1=new Product(1l,"Shalvar Lee",229600l,cat1,50);
        Product p2=new Product(2l,"Hoodi",220000l,cat1,5);
        Product p3=new Product(3l,"Note 8 Pro",260000l,cat2,25);
        Product p4=new Product(4l,"Iphone 13",60000l,cat2,30);
        Product p5=new Product(5l,"MacPro",290000l,cat3,80);
        Product p6=new Product(6l,"Lenovo",440000l,cat3,90);
